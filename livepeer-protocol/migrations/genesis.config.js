...
module.exports = {
    ...
    crowdSupply: new BN(6343700).mul(TOKEN_UNIT),
    companySupply: new BN(500000).mul(TOKEN_UNIT),
    teamSupply: new BN(1235000).mul(TOKEN_UNIT),
    investorsSupply: new BN(1900000).mul(TOKEN_UNIT),
    communitySupply: new BN(21300).mul(TOKEN_UNIT),
    ...
    teamGrants: [
        {
            ...
            amount: new BN(500000).mul(TOKEN_UNIT)
        },
        {
        ...
        },
        {
            ...
            amount: new BN(60000).mul(TOKEN_UNIT)
        },
        {
            receiver: "0x02a7Db34a9415642BC8d9899E29b43E070546A00",
            amount: new BN(25000).mul(TOKEN_UNIT)
        },
        {
            receiver: "0xc7d6d54a4360b42fa0759e12de990bfd4b13d3c3",
            amount: new BN(20000).mul(TOKEN_UNIT)
        },
        {
        ...
        },
        {
            ...
            amount: new BN(50000).mul(TOKEN_UNIT)
        },
        {
            receiver: "0x85a48E017c2f09037046656F2dbB063c3C1d3CE2",
            amount: new BN(55000).mul(TOKEN_UNIT)
        }
    ],
    ...
    investorGrants: [
        ...
        },
        {
            ...
            amount: new BN(83333).mul(TOKEN_UNIT)
        },
        {
            receiver: "0x9dbF125B97DD49915E54C63eed81545edc1B20dB",
            amount: new BN(166667).mul(TOKEN_UNIT)
        },
        {
            receiver: "0x8d95adcFdC1aBEB7385C298C09b8592DcB6dF6eC",
            amount: new BN(33333).mul(TOKEN_UNIT)
        },
        {
        ...
        },
        {
            ...
            amount: new BN(183333).mul(TOKEN_UNIT)
        },
        {
            receiver: "0xeB73C744B95c75709F362E42769ffeFc71952432",
            amount: new BN(66667).mul(TOKEN_UNIT)
        },
        {
        ...
        },
        {
            ...
            amount: new BN(16667).mul(TOKEN_UNIT)
        },
        {
        ...
        },
        {
            ...
            amount: new BN(5000).mul(TOKEN_UNIT)
        }
    ],
    communityGrants: [
        {
            receiver: "0x85a48E017c2f09037046656F2dbB063c3C1d3CE2",
            amount: new BN(2000).mul(TOKEN_UNIT)
        },
        {
            receiver: "0x11Ab5Ec22AE6772CD3a704717b3c9d7B8224631b",
            amount: new BN(500).mul(TOKEN_UNIT)
        },
        {
            receiver: "0x064d7f14CA21C9616d419e6d60Fe1d4EF0BD8315",
            amount: new BN(7500).mul(TOKEN_UNIT)
        },
        {
        ...
        },
        {
            ...
            amount: new BN(1000).mul(TOKEN_UNIT)
        },
        {
        ...
        },
        {
            ...
            amount: new BN(750).mul(TOKEN_UNIT)
        },
        {
        ...
        },
        {
            ...
            amount: new BN(300).mul(TOKEN_UNIT)
        },
        {
        ...
        },
        {
            ...
            amount: new BN(3000).mul(TOKEN_UNIT)
        }
    ]
}
